...
L_{f}(x, y) &=
\begin{pmatrix} 1 \\ 2 \end{pmatrix} +
\begin{pmatrix} x - 1 + y - 1 \\ 2x - 3 + 2y - 3 \end{pmatrix} \\
&=
\begin{pmatrix} 1 \\ 2 \end{pmatrix} +
\begin{pmatrix} x + y - 2 \\ 2x + 2y - 6 \end{pmatrix} \\
&=
\begin{pmatrix} x + y - 1 \\ 2x + 2y - 4 \end{pmatrix} \\
L_{f}(1.01, 0.98) &= \begin{pmatrix} 1.01 + 0.98 - 1 \\ 2(1.01) + 2(0.98) - 4 \end{pmatrix} \\
&= \begin{pmatrix} 0.99 \\ -0.02 \end{pmatrix} \\
\end{align*}
