...
disprove: If R is an equivalence relation on the set A = {a,b,c}. Describe them all. (Here you can just draw a picture instead of text if you prefer.)
